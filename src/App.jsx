        ...
        <div className="form__container">
          <form className="form" onSubmit={onSubmit}>
            ...
            <input 
                ...
                autoComplete="off"
            />
            <p className="inputError">Please enter a valid username.</p>
            ...
            <p class="form__cta">New to Netflix?<span class="cta-span">Sign up now.</span></p>
            <p class="form__recaptcha">This page is protected by Google reCAPTCHA to ensure you're not a bot. <span>Learn More.</span></p>
          </form>
        </div>
